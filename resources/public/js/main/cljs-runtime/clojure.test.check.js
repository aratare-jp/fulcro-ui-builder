...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44490_44610) : reporter_fn.call(null,G__44490_44610));
...
var vec__44494 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44494,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44494,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44504){
var map__44505 = p__44504;
var map__44505__$1 = (((((!((map__44505 == null))))?(((((map__44505.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44505.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44505):map__44505);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44505__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44505__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44505__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44509 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44509,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44509,(1),null);
...
var size = first__44526;
var rest_size_seq = seq__44525__$1;
var vec__44527 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44527,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44527,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44500){
var G__44501 = cljs.core.first(seq44500);
var seq44500__$1 = cljs.core.next(seq44500);
var G__44502 = cljs.core.first(seq44500__$1);
var seq44500__$2 = cljs.core.next(seq44500__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44501,G__44502,seq44500__$2);
}));
...
var map__44542 = smallest;
var map__44542__$1 = (((((!((map__44542 == null))))?(((((map__44542.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44542.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44542):map__44542);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44542__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__44668 = tail;
var G__44669 = current_smallest;
var G__44670 = (total_nodes_visited + (1));
var G__44671 = depth;
nodes = G__44668;
current_smallest = G__44669;
total_nodes_visited = G__44670;
depth = G__44671;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44561_44676 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44561_44676) : reporter_fn.call(null,G__44561_44676));

var temp__5733__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5733__auto__){
var children = temp__5733__auto__;
var G__44677 = children;
var G__44678 = new_smallest;
var G__44679 = (total_nodes_visited + (1));
var G__44680 = (depth + (1));
nodes = G__44677;
current_smallest = G__44678;
total_nodes_visited = G__44679;
depth = G__44680;
continue;
} else {
var G__44681 = tail;
var G__44682 = new_smallest;
var G__44683 = (total_nodes_visited + (1));
var G__44684 = depth;
nodes = G__44681;
current_smallest = G__44682;
total_nodes_visited = G__44683;
depth = G__44684;
continue;
}
}
...
var G__44581_44693 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44581_44693) : reporter_fn.call(null,G__44581_44693));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44562_SHARP_){
var G__44582 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44562_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44582) : reporter_fn.call(null,G__44582));
}));
var G__44589_44695 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44589_44695) : reporter_fn.call(null,G__44589_44695));

 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__43389){
var vec__43390 = p__43389;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43390,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43390,(1),null);
var ref = vec__43390;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__43395){
var vec__43396 = p__43395;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43396,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43396,(1),null);
var ref = vec__43396;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__43399){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43400__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__43402,entity,state_map,parent_node,idents_seen){
...
var join_node = map__43403__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43403__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43403__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__43405,entity,state_map,idents_seen){
var map__43406 = p__43405;
var map__43406__$1 = (((((!((map__43406 == null))))?(((((map__43406.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43406.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__43406):map__43406);
var join_node = map__43406__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43406__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__43408){
...
var node = map__43409__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43409__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__43413 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43413,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__43416 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__43416) : union_key__GT_query.call(null,G__43416));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__43419,current_entity,state_map,idents_seen){
...
var top_node = map__43420__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43420__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43420__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__43426 = nil_nodes;
var G__43426__$1 = (((G__43426 == null))?null:cljs.core.first(G__43426));
if((G__43426__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__43426__$1);
}
})());
} else {
...
var G__43427 = result_node__$1;
var G__43427__$1 = (((G__43427 == null))?null:cljs.core.persistent_BANG_(G__43427));
if((G__43427__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43427__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43430 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__43430 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43430,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43431 = props;
var G__43431__$1 = (((G__43431 == null))?null:cljs.core.meta(G__43431));
if((G__43431__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__43431__$1);
}
});

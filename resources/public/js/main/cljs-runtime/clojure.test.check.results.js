...
var clojure$test$check$results$Result$pass_QMARK_$dyn_43641 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_43641(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_43646 = (function (result){
var x__4422__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_43646(result);
}
});

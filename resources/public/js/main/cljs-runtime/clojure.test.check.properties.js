...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4376__auto__,k44697,else__4377__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k44697,else__4377__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4396__auto__,p__44729){
var vec__44730 = p__44729;
var k__4397__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44730,(0),null);
var v__4398__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44730,(1),null);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__44696){
var self__ = this;
var G__44696__$1 = this;
return (new cljs.core.RecordIter((0),G__44696__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this44698,other44699){
var self__ = this;
var this44698__$1 = this;
return (((!((other44699 == null)))) && ((this44698__$1.constructor === other44699.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44698__$1.error,other44699.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44698__$1.__extmap,other44699.__extmap)));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4381__auto__,k__4382__auto__,G__44696){
var self__ = this;
var this__4381__auto____$1 = this;
var pred__44762 = cljs.core.keyword_identical_QMARK_;
var expr__44763 = k__4382__auto__;
if(cljs.core.truth_((pred__44762.cljs$core$IFn$_invoke$arity$2 ? pred__44762.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__44763) : pred__44762.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44763)))){
return (new clojure.test.check.properties.ErrorResult(G__44696,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4382__auto__,G__44696),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4373__auto__,G__44696){
var self__ = this;
var this__4373__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__44696,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__44714){
var extmap__4413__auto__ = (function (){var G__44780 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__44714,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__44714)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__44780);
} else {
return G__44780;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__44714),null,cljs.core.not_empty(extmap__4413__auto__),null));
});

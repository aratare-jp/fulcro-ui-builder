...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43267){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43268,G__43269,seq43267__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43280_SHARP_){
return (!((cljs.core.meta(p1__43280_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43289__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43294){var _e__41886__auto__ = e43294;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e43296){var _e__41886__auto__ = e43296;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43306 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43307 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43307);

try{var map__43308 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43308__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43306);
}});
...
var temp__5733__auto___43347 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43347)){
var managed_print_level_43348 = temp__5733__auto___43347;
var _STAR_print_level_STAR__orig_val__43312_43349 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43313_43350 = managed_print_level_43348;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43313_43350);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43310_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43310_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43312_43349);
}} else {
job_fn();
}

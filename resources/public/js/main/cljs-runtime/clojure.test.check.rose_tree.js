...
return cljs.core.cons(cljs.core.first(s),(function (){var G__43436 = (n - (1));
var G__43437 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__43436,G__43437) : clojure.test.check.rose_tree.exclude_nth.call(null,G__43436,G__43437));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__43441 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__43441) : f.call(null,G__43441));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43440_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__43440_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__43440_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43444_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__43444_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__43444_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43445_SHARP_){
var G__43447 = clojure.test.check.rose_tree.root(p1__43445_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__43447) : pred.call(null,G__43447));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__43448(s__43449){
return (new cljs.core.LazySeq(null,(function (){
var s__43449__$1 = s__43449;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__43449__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__43454 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43454,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43454,(1),null);
var iterys__4519__auto__ = ((function (s__43449__$1,vec__43454,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__43448_$_iter__43450(s__43451){
return (new cljs.core.LazySeq(null,((function (s__43449__$1,vec__43454,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__43451__$1 = s__43451;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__43451__$1);
if(temp__5735__auto____$1){
var s__43451__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43451__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__43451__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__43453 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__43452 = (0);
while(true){
if((i__43452 < size__4522__auto__)){
var child = cljs.core._nth(c__4521__auto__,i__43452);
cljs.core.chunk_append(b__43453,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__43535 = (i__43452 + (1));
i__43452 = G__43535;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43453),clojure$test$check$rose_tree$permutations_$_iter__43448_$_iter__43450(cljs.core.chunk_rest(s__43451__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43453),null);
}
} else {
var child = cljs.core.first(s__43451__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__43448_$_iter__43450(cljs.core.rest(s__43451__$2)));
}
} else {
return null;
}
...
});})(s__43449__$1,vec__43454,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__43449__$1,vec__43454,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,clojure$test$check$rose_tree$permutations_$_iter__43448(cljs.core.rest(s__43449__$1)));
} else {
var G__43537 = cljs.core.rest(s__43449__$1);
s__43449__$1 = G__43537;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43465_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__43465_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__43465_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43473_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__43473_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__43473_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__43482 = f;
var G__43483 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__43482,G__43483) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__43482,G__43483));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__43488 = f;
var G__43489 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__43488,G__43489) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__43488,G__43489));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {

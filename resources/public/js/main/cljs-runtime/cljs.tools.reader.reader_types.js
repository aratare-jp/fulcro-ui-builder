...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45560 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45560(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45574 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45574(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45637 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45637(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45646 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45646(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45653 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45653(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45659 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45659(reader);
}
});
...
var G__45952 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45953 = s.append(c);
c = G__45952;
s = G__45953;
continue;
}

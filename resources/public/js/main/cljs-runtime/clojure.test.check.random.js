...
var clojure$test$check$random$IRandom$rand_long$dyn_43480 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_43480(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_43490 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_43490(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_43499 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_43499(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_43500 = (function (rng,n){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_43500(rng,n);
}
});
...
var G__43438 = z;
if(((24) > (function (){var G__43439 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__43439) : clojure.test.check.random.longs.bit_count.call(null,G__43439));
})())){
return clojure.test.check.random.longs.bit_xor(G__43438,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__43438;
}
});
...
var G__43514 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__43515 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__43514;
ret = G__43515;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__43461){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43462__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__43466 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43466,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43466,(1),null);

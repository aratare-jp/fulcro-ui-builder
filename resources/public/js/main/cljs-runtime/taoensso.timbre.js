...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44992__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44992__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__44993 = data;
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44993__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var len__4730__auto___45100 = arguments.length;
var i__4731__auto___45101 = (0);
while(true){
if((i__4731__auto___45101 < len__4730__auto___45100)){
args__4736__auto__.push((arguments[i__4731__auto___45101]));

var G__45102 = (i__4731__auto___45101 + (1));
i__4731__auto___45101 = G__45102;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq45010){
var G__45011 = cljs.core.first(seq45010);
var seq45010__$1 = cljs.core.next(seq45010);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45011,seq45010__$1);
}));
...
return ((function (){var G__45033 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__45033) : taoensso.timbre._levels_map.call(null,G__45033));
})() >= (function (){var G__45034 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__45034) : taoensso.timbre._levels_map.call(null,G__45034));
})());
});
...
var fexpr__45038 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__45038.cljs$core$IFn$_invoke$arity$1 ? fexpr__45038.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__45038.call(null,_QMARK_ns));
}));
/**
...
var vec__45053 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45053,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__45059 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45059,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__45062 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45062,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_45129 = taoensso.encore.now_dt();
var context_45130 = taoensso.timbre._STAR_context_STAR_;
var vargs_45131 = cljs.core.deref(vargs_);
var vec__45073_45132 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_45131);
var _QMARK_err_45133__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45073_45132,(0),null);
var _QMARK_meta_45134 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45073_45132,(1),null);
var _QMARK_msg_fmt_45135 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45073_45132,(2),null);
var vargs_45136__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45073_45132,(3),null);
var data_45137 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4120__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_45129,config,vargs_45136__$1,_QMARK_file,(function (){var fexpr__45079 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__45079.cljs$core$IFn$_invoke$arity$1 ? fexpr__45079.cljs$core$IFn$_invoke$arity$1(level) : fexpr__45079.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_45133__$1,context_45130,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_45133__$1;
}),null)),_QMARK_meta_45134,_QMARK_msg_fmt_45135]));
var _QMARK_data_45138 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_45137,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5735__auto___45144 = _QMARK_data_45138;
if(cljs.core.truth_(temp__5735__auto___45144)){
var data_45146__$1 = temp__5735__auto___45144;
var map__45083_45147 = data_45146__$1;
var map__45083_45148__$1 = (((((!((map__45083_45147 == null))))?(((((map__45083_45147.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45083_45147.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45083_45147):map__45083_45147);
var vargs_45149__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45083_45148__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_45150__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_45146__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_45149__$2;
}),null)));
var data_45151__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_45150__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__45085 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__45085)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__45085)){
return taoensso.timbre.str_join(vargs_45149__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__45085)){
if(typeof _QMARK_msg_fmt_45135 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_45135,vargs_45149__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45085)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_45135,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_45134,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_45149__$2)], null));
}),null))], 0));
var output_fn1_45152 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__45093 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_45151__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__45093) : rl_fn.call(null,G__45093));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__45094 = appender;
...
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45094__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45094__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_45152;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay((function (){
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(data_45151__$3) : output_fn.call(null,data_45151__$3));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_45151__$3,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
var args__4736__auto__ = [];
var len__4730__auto___45176 = arguments.length;
var i__4731__auto___45177 = (0);
while(true){
if((i__4731__auto___45177 < len__4730__auto___45176)){
args__4736__auto__.push((arguments[i__4731__auto___45177]));

var G__45178 = (i__4731__auto___45177 + (1));
i__4731__auto___45177 = G__45178;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq45098){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45098));
}));

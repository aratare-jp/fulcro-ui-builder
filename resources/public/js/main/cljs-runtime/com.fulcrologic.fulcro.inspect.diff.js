...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__39918){
var vec__39924 = p__39918;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__39947){
var vec__39949 = p__39947;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39949,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39949,(1),null);
var temp__5733__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5733__auto__)){
var vec__39955 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39955,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39955,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__39962 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39962,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__39962;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__39984){
var map__39987 = p__39984;
...
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39987__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__40017){
var map__40022 = p__40017;
...
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40022__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__40032 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__40010_SHARP_){
var G__40038 = p1__40010_SHARP_;
var G__40039 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__40038,G__40039) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__40038,G__40039));
}));
} else {

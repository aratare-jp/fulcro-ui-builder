...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47427_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__47427_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47428_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__47428_SHARP_);
}),tokens);
...
var G__47432 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47432,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__47432;
}
} else {
...
var map__47438 = com.fulcrologic.fulcro.dom_common.parse(kw);
...
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47438__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47438__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__47442 = (function (){var or__4120__auto__ = props;
...
var G__47442__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47442,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__47442);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47442__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__47442__$1;
}
}

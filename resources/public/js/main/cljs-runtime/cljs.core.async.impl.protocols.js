...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_49731 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_49731(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_49732 = (function (port,val,fn1_handler){
var x__4422__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_49732(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_49735 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_49735(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_49740 = (function (chan){
var x__4422__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_49740(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_49741 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_49741(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_49748 = (function (h){
var x__4422__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_49748(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_49750 = (function (h){
var x__4422__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_49750(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_49759 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_49759(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_49764 = (function (b){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_49764(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_49774 = (function (b,itm){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_49774(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_49783 = (function (b){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_49783(b);
}
});

...
var len__4730__auto___45498 = arguments.length;
var i__4731__auto___45499 = (0);
while(true){
if((i__4731__auto___45499 < len__4730__auto___45498)){
args__4736__auto__.push((arguments[i__4731__auto___45499]));

var G__45500 = (i__4731__auto___45499 + (1));
i__4731__auto___45499 = G__45500;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__45355_45502 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45356_45503 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45357_45504 = true;
var _STAR_print_fn_STAR__temp_val__45358_45505 = (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45357_45504);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45358_45505);

try{var _STAR_print_level_STAR__orig_val__45365_45509 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45366_45510 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45366_45510);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45365_45509);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45356_45503);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45355_45502);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq45351){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45351));
}));
...
var new_formatters = current_formatters.filter((function (p1__45412_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__45412_SHARP_)));
}));
...
var G__45424_45557 = f;
var target__41880__auto___45558 = G__45424_45557;
if(cljs.core.truth_(target__41880__auto___45558)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45424_45557)].join(''),"\n","target__41880__auto__"].join('')));
}

(target__41880__auto___45558["toString"] = (function (){
...
var G__45430_45564 = "%c%s";
var G__45431_45565 = "color:transparent";
var G__45432_45566 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__45430_45564,G__45431_45565,G__45432_45566) : f.call(null,G__45430_45564,G__45431_45565,G__45432_45566));
...
var args__4736__auto__ = [];
var len__4730__auto___45585 = arguments.length;
var i__4731__auto___45587 = (0);
while(true){
if((i__4731__auto___45587 < len__4730__auto___45585)){
args__4736__auto__.push((arguments[i__4731__auto___45587]));

var G__45588 = (i__4731__auto___45587 + (1));
i__4731__auto___45587 = G__45588;
continue;
} else {
}
break;
...
var vec__45445 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45445,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45445,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__45591__delegate = function (add_fmt,add_args){
...
var G__45591 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__45594__i = 0, G__45594__a = new Array(arguments.length -  1);
while (G__45594__i < G__45594__a.length) {G__45594__a[G__45594__i] = arguments[G__45594__i + 1]; ++G__45594__i;}
  add_args = new cljs.core.IndexedSeq(G__45594__a,0,null);
} 
return G__45591__delegate.call(this,add_fmt,add_args);};
G__45591.cljs$lang$maxFixedArity = 1;
G__45591.cljs$lang$applyTo = (function (arglist__45595){
var add_fmt = cljs.core.first(arglist__45595);
var add_args = cljs.core.rest(arglist__45595);
return G__45591__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq45440){
var G__45441 = cljs.core.first(seq45440);
var seq45440__$1 = cljs.core.next(seq45440);
var G__45442 = cljs.core.first(seq45440__$1);
var seq45440__$2 = cljs.core.next(seq45440__$1);
var G__45443 = cljs.core.first(seq45440__$2);
var seq45440__$3 = cljs.core.next(seq45440__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45441,G__45442,G__45443,seq45440__$3);
}));
...
var seq__45456 = cljs.core.seq(features);
var chunk__45457 = null;
var count__45458 = (0);
var i__45459 = (0);
while(true){
if((i__45459 < count__45458)){
var feature = chunk__45457.cljs$core$IIndexed$_nth$arity$2(null,i__45459);
...
var G__45609 = seq__45456;
var G__45610 = chunk__45457;
var G__45611 = count__45458;
var G__45612 = (i__45459 + (1));
seq__45456 = G__45609;
chunk__45457 = G__45610;
count__45458 = G__45611;
i__45459 = G__45612;
continue;
} else {
...
var c__4550__auto__ = cljs.core.chunk_first(seq__45456__$1);
var G__45615 = cljs.core.chunk_rest(seq__45456__$1);
var G__45616 = c__4550__auto__;
var G__45617 = cljs.core.count(c__4550__auto__);
var G__45618 = (0);
seq__45456 = G__45615;
chunk__45457 = G__45616;
count__45458 = G__45617;
i__45459 = G__45618;
continue;
} else {
var feature = cljs.core.first(seq__45456__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__45623 = cljs.core.next(seq__45456__$1);
var G__45624 = null;
var G__45625 = (0);
var G__45626 = (0);
seq__45456 = G__45623;
chunk__45457 = G__45624;
count__45458 = G__45625;
i__45459 = G__45626;
continue;
}
} else {
...
var G__45472 = feature;
var G__45472__$1 = (((G__45472 instanceof cljs.core.Keyword))?G__45472.fqn:null);
switch (G__45472__$1) {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o45487 = temp__5733__auto__;
return (o45487["version"]);
} else {
return null;
}
})() == null);

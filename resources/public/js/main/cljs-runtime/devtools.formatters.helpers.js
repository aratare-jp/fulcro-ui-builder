...
var G__43264 = devtools.prefs.pref(v);
v = G__43264;
continue;
} else {
return v;
...
}catch (e43228){var _e__41886__auto__ = e43228;
return false;
}})();
...
}catch (e43233){var _e__41886__auto__ = e43233;
return false;
}})();
...
}catch (e43235){var _e__41886__auto__ = e43235;
return false;
}}
}
});
...
var vec__43247 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__43254_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43254_SHARP_);
}),template);
});

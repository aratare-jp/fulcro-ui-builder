...
var vec__45106 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45106,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45106,(1),null);
...
var expr__$1 = (function (){var G__45112 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__45112);
} else {
return G__45112;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__45117 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__45117) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__45117));
} else {
return expr;
...
var len__4730__auto___45186 = arguments.length;
var i__4731__auto___45187 = (0);
while(true){
if((i__4731__auto___45187 < len__4730__auto___45186)){
args__4736__auto__.push((arguments[i__4731__auto___45187]));

var G__45190 = (i__4731__auto___45187 + (1));
i__4731__auto___45187 = G__45190;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq45123){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45123));
}));
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"root","root",-448657453),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast))){
return edn_query_language.core.ast__GT_query(ast);
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [edn_query_language.core.ast__GT_expr.cljs$core$IFn$_invoke$arity$2(ast,true)], null);
}
});
